    ...
    return `<div
                ...
                >
                    ...
                    <div class="flex justify-center gap-[30px] lg:items-center flex-wrap">
                        ...
                        <a
                            class="flex bg-purple-700 px-[20px] py-[7px] h-[45px] w-[60%] text-white  rounded-md font-semibold justify-center items-center gap-[10px] lg:h-fit lg:py-[9px] lg:w-fit"
                            href=""
                            >Ver más
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a class="flex bg-purple-700 px-[20px] py-[7px] h-[45px] w-[60%] text-white rounded-md font-semibold justify-center items-center gap-[10px] lg:h-fit lg:py-[9px] lg:w-fit"
                            href=""
                            > Reasignar
